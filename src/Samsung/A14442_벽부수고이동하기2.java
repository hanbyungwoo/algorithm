...
public class A14442_º®ºÎ¼ö°íÀÌµ¿ÇÏ±â2 {
	...
	public static void main(String args[]) throws IOException {
		...
		int N = Integer.parseInt(st.nextToken());	// ¼¼·Î 6
		int M = Integer.parseInt(st.nextToken());	// °¡·Î 4
		int K = Integer.parseInt(st.nextToken());	// ÆøÅº¼ö
